...
export function Pricing() {
  ...
  return (
    <section id="pricing" className="py-32 bg-dark-surface relative overflow-hidden">
      <div className="absolute inset-0 dot-pattern opacity-20" />
      
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-h2 lg:text-h1 font-heading font-bold text-white mb-4">
            Simple, <span className="gradient-text-primary">Agent-Based</span> Pricing
          </h2>
          <p className="text-body-lg text-dark-muted max-w-2xl mx-auto">
            Start with a few agents, scale to the full hierarchy. No hidden fees.
          </p>
        </div>
