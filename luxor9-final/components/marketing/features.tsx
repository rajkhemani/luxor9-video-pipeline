...
export function Features() {
  ...
  return (
    <section id="features" className="py-32 bg-dark-surface relative overflow-hidden">
      <div className="absolute inset-0 dot-pattern opacity-30" />
      
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-h2 lg:text-h1 font-heading font-bold text-white mb-4">
            Multi-Agent <span className="gradient-text-primary">Orchestration</span>
          </h2>
          <p className="text-body-lg text-dark-muted max-w-2xl mx-auto">
            Not just a collection of agents — a coordinated hierarchy that plans, delegates, and executes as a team.
          </p>
        </div>
