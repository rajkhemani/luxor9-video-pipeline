...
export function HowItWorks() {
  ...
  return (
    <section id="how-it-works" className="py-32 bg-dark-bg relative overflow-hidden">
      <div className="absolute inset-0 grid-pattern opacity-30" />
      
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-h2 lg:text-h1 font-heading font-bold text-white mb-4">
            How Agent <span className="gradient-text-primary">Teams</span> Work
          </h2>
          <p className="text-body-lg text-dark-muted max-w-2xl mx-auto">
            From objective to execution in three steps. The hierarchy handles the complexity.
          </p>
        </div>
        ...
        >
          <div className="rounded-xl border border-dark-border bg-dark-surface overflow-hidden">
            ...
            <div className="p-6 font-mono text-sm">
              <p className="text-dark-muted mb-2"># Deploy your agent team</p>
              <p className="text-primary mb-4">luxor9 deploy --goal "research competitors and generate a report"</p>
              <p className="text-dark-subtle mb-2">LUXOR-PRIME: Decomposing objective into subtasks...</p>
              <p className="text-dark-subtle mb-2">CORTEX: Assigning scouts for market research...</p>
              <p className="text-dark-subtle mb-2">FORGE: Build agents preparing report template...</p>
              <p className="text-dark-subtle mb-2">SENTINEL: Monitoring execution across the hierarchy...</p>
              <p className="text-accent-success">
                <span className="text-primary">✓</span> Agent team completed objective
              </p>
            </div>
          </div>
        </motion.div>
