      ...
      <div className="relative z-10 mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <h2 className="text-h2 lg:text-h1 font-heading font-bold text-white mb-6">
            Ready to Deploy Your <span className="gradient-text-primary">Agent Team</span>?
          </h2>
          
          <p className="text-body-lg text-dark-muted mb-12 max-w-xl mx-auto">
            Join developers already orchestrating multi-agent workflows. 
            Get early access to the full hierarchy.
          </p>
